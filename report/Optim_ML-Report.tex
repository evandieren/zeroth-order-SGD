...
% Bibliography
\usepackage[square, numbers]{natbib} % a specific citation style
...
\input{style/configuration} % to specify data used in the title page
\input{style/macros} % define all your macros here

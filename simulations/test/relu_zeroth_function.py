...
class ReLU_Zeroth_Function(Function):
...
class ReLU_Zeroth(torch.nn.Module):
    ...
    def __init__(self, difference_method : str = None, mu : float = None, n : int = None) -> None:
        super().__init__()
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        return ReLU_Zeroth_Function.apply(input, self.difference_method, self.mu, self.n)
